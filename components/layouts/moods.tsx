    ...
    <div className="min-h-screen max-w-6xl mx-auto py-6 px-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <Button variant="ghost" className="bg-blue-500 text-white hover:bg-blue-500/70 hover:text-white" onClick={() => router.push("/")}>
            <Home className="w-4 h-4 mr-2" />
            Home
          </Button>
          <Button className="bg-gray-600 text-white hover:bg-gray-400/70" 
